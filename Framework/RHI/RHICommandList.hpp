...
namespace RHI
{
    ...
    public:
        ...
        virtual void CopyBufferToTexture(RHIBuffer* buffer, RHITexture* texture, uint32_t mipLevel, uint32_t arraySlice, uint32_t offset) = 0;
        virtual void CopyTextureToBuffer(RHITexture* texture, RHIBuffer* buffer, uint32_t mipLevel, uint32_t arraySlice) = 0;
        ...
        virtual void TextureBarrier(RHITexture* texture, uint32_t subResouce, ERHIAccessFlags before, ERHIAccessFlags after) = 0;
        virtual void BufferBarrier(RHIBuffer* buffer, ERHIAccessFlags before, ERHIAccessFlags after) = 0;
        virtual void GlobalBarrier(ERHIAccessFlags before, ERHIAccessFlags after) = 0;
